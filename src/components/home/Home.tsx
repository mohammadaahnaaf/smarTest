          ...
          <div className="relative">
            <div className="lg:w-2/3">
              ...
              <div className="relative inline-flex items-center justify-center mt-8 sm:mt-12 group">
                ...
                <button
                  className="relative inline-flex items-center justify-center px-8 py-3 text-base font-normal text-white bg-black border border-transparent rounded-lg"
                >
            ...
            <div className="mt-8 md:absolute md:mt-0 md:top-32 lg:top-0 md:right-0">
              <div className='relative h-[50vh] w-[60vh]'>
